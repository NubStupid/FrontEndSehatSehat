...
class CustomerServiceViewModel(
    ...
    fun init(username:String, chatGroup:String){
        viewModelScope.launch {
            ...
            _chatMessages.value = sehatRepository.getFromCSChatLog(username).sortedByDescending{
                it.createdAt
            }
    ...
    fun chatbotSync(chatGroup:String){
        viewModelScope.launch {
            ...
            if(username.value != null){
                _chatMessages.value = sehatRepository.getFromCSChatLog(username.value).sortedByDescending{
                    it.createdAt
                }
            }
        }
    ...
    fun sendMessages(){
        viewModelScope.launch {
            sehatRepository.chatToCustomerService(currentMessage.value!!,username.value!!, chatGroup.value!!)
            _chatMessages.value = sehatRepository.getFromCSChatLog(username.value!!).sortedByDescending{
                it.createdAt
            }
